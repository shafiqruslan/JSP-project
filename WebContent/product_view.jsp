              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><c:out value="${product.product_ori_price}" /></td>
                  </tr>
                  <tr>
                    <th scope="row">SELLING PRICE</th>
                    <td colspan="2"><c:out value="${product.product_sell_price}" /></td>
                  </tr>
                  <tr>
                    <th scope="row">PROFIT</th>
                    <td colspan="2"><c:out value="${product.product_profit}" /></td>
                  </tr>
                  <tr>
                    <th scope="row">SUPPLIER NAME</th>
                    <td colspan="2"><c:out value="${product.product_supplier}" /></td>
                  </tr>
                </tbody>
              </table>
            </div>
